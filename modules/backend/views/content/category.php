...
<div class="row">
  <div class="col-md-5">
    <h3 class="sub_tit">Add new category</h3>
    ...
    <div class="form_group">
      ...
      <?php
      if(!empty($cates)){
        echo dropdown_from_array($cates);
      }
      ?>
    ...
    <div class="form-group">
      <?php echo form_submit('submit','Add new category', array('class'=>'btn btn-sm btn-primary'));?>
    </div>
    <?php echo form_close();?>
  </div>
  <div class="col-md-7">
        ...
        <tbody>
          <?php if(!empty($cates)):?>
            <?php foreach ($cates as $key => $cate): ?>
              ...
              <?php if(isset($cate['sub'])):?>
                <?php foreach ($cate['sub'] as $k => $sub): ?>
                  <tr>
                    <td>
                      <input type="checkbox" value="" name="name">
                    </td>
                    <td>
                      <strong><?php echo anchor(site_url('admin/posts/categories/'.$sub['term_id']),'-- '.$sub['name'])?> </strong>
                      <div class="row_action">
                        <span><a href="#">View</a> |</span>
                        <span><a href="http://base.dev/admin/posts/edit/13">Edit</a> |</span>
                        <span><a class="delete" href="http://base.dev/admin/posts/delete/13">Delete</a> </span>
