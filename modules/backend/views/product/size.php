...
<h1 class="tit">
  <?php
  echo $template['title'];
  echo anchor(ADMIN_FOLDER.'/'.$module.'/size','Add New','class="page-title-action"');
  ?>
</h1>
<div class="row">
  <div class="col-md-5">
    <!-- <h3 class="sub_tit">Add new size</h3> -->
    ...
    <div class="table-responsive">
      ...
      if(isset($cates) && !empty($cates)){
        foreach ($cates as $key => $cate) {
          ...
          '<strong>'.anchor(site_url(ADMIN_FOLDER.'/'.$module.'/size/'.$cate['term_id']),$cate['name']) .'</strong>
